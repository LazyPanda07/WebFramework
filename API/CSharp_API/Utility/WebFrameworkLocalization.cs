...
public static unsafe partial class WebFrameworkLocalization
{
	...
	private static unsafe partial string getWebFrameworkLocalizedString(string localizationModuleName, string key, string language, ref void* exception);

	public static string GetLocalizedString(string localizationModuleName, string key, string? language = null)
	{
		void* exception = null;
		string result = getWebFrameworkLocalizedString(localizationModuleName, key, language ?? "", ref exception);
