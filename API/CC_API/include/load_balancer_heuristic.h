...
#define DEFINE_HEURISTIC(structName) WEB_FRAMEWORK_HEURISTIC_FUNCTIONS_API void* create##structName##CCHeuristic(const char* ip, const char* port, bool useHTTPS)	\
{	\
