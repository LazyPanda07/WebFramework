...
call LoadBalancerCore.exe --port 9090 --load_balancer_run_arguments "load_balancer_server.py" --config load_balancer_config.json %RUNTIMES% || exit 1
call LoadBalancerCore.exe --port 9092 --load_balancer_run_arguments "load_balancer_server.py" --config load_balancer_config_https.json --useHTTPS %RUNTIMES% || exit 1 REM needs to initialize runtimes for https config before using it
call LoadBalancerCore.exe --port 9091 --load_balancer_run_arguments "load_balancer_server.py" --config load_balancer_config.json --serversHTTPS %RUNTIMES% || exit 1
call LoadBalancerCore.exe --port 9093 --load_balancer_run_arguments "load_balancer_server.py" --config load_balancer_config_https.json --serversHTTPS --useHTTPS %RUNTIMES% || exit 1
call LoadBalancerCore.exe --port 9094 --load_balancer_run_arguments "load_balancer_server.py" --config load_balancer_config.json --custom_heuristic %RUNTIMES% || exit 1
call ProxyCore.exe --port 15000 --load_balancer_run_arguments "load_balancer_server.py" --proxy_run_arguments "python proxy_server.py" %RUNTIMES% || exit 1
call ProxyCore.exe --port 15001 --load_balancer_run_arguments "load_balancer_server.py" --proxy_run_arguments "python proxy_server.py" --useHTTPS %RUNTIMES% || exit 1
