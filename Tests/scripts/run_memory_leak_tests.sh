...
valgrind --max-threads=1000 --leak-check=full --show-leak-kinds=all --track-origins=yes --log-file=memory_leaks_result.txt ./Server ${WEB_FRAMEWORK_SERVER_CONFIG} & sleep 30
