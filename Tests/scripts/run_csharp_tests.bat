...
start dotnet CSharpProxyServer.dll --config proxy_config.json --port 15001 --useHTTPS
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config.json --port 9090
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config.json --port 9091 --serversHTTPS
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config_https.json --port 9092
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config_https.json --port 9093 --serversHTTPS
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config.json --port 9094 --custom_heuristic
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config.json --type server --port 10000
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config.json --type server --port 10001 --serversHTTPS
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config_https.json  --type server --port 10002
start dotnet CSharpLoadBalancerServer.dll --config load_balancer_config_https.json --type server --port 10003 --serversHTTPS
