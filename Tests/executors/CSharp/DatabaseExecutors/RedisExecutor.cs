...
public class RedisExecutor : StatelessExecutor
{
	...
	{
		Table connect = request.GetTable<RedisDatabase>("127.0.0.1:8080:password", "");
	...
	{
		request.GetOrCreateDatabase<RedisDatabase>("127.0.0.1:8080:password").GetOrCreateTable("", "");
