...
namespace framework
{
	...
	protected:
		static ServiceState serveTask(streams::IOSocketStream& stream, HttpRequestImplementation& request, HttpResponseImplementation& response, ResourceExecutor& resources, const std::function<void(ServiceState&)>& task);
