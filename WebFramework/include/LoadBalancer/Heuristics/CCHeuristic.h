...
{
	class WEB_FRAMEWORK_API CCHeuristic : public LoadBalancerHeuristic
	{
	private:
	...
	public:
		CCHeuristic(std::string_view ip, std::string_view port, bool useHTTPS, std::string_view heuristicName, HMODULE handle);
