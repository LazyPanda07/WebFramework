...
namespace framework
{
	...
	public:
		WebServer(const utility::XMLSettingsParser& parser, const std::filesystem::path& assets, bool isCaching, const std::string_view& port = HTTPPort, DWORD timeout = 0, const std::string& pathToExecutable = "");
